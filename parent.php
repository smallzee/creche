...
if (isset($_POST['add'])){
    ...
    if (empty($fname) or empty($phone) or empty($occupation) or empty($address)){
    ...
    if ($error_count == 0){
        ...
        $in = $db->query("INSERT INTO ".DB_PREFIX."parents (fname,email,phone,occupation,address,school_fee_deduction)
        VALUES('$fname','$email','$phone','$occupation','$address','$deduction')");
                    ...
                    <div class="table-responsive">
                        <table class="table table-bordered table-striped" id="example1">
                            ...
                            <tr>
                                ...
                                <th>Phone Number</th>
                                <th>Occupation</th>
                                <th>Deduct School Fee From Salary</th>
                                <th>Created At</th>
                                <th>Actions</th>
                            </tr>
                            </thead>
                            ...
                            <?php
                                ...
                                while ($rs = $sql->fetch(PDO::FETCH_ASSOC)){
                                    ...
                                    <tr>
                                        ...
                                        <td><?= !(empty($rs['school_fee_deduction'])) ? $rs['school_fee_deduction'] : 'N/A'; ?></td>
                                        <td><?= $rs['created_at'] ?></td>
